...
#    Updated: 2025/03/15 22:23:53 by arcebria         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = minishell

SRCS = src/main.c src/init_env.c src/tokenizer.c src/free_stuff.c src/parser.c src/syntax_analize.c src/parse_cmd.c
OBJS = $(SRCS:.c=.o)
